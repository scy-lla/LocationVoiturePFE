<?php
// 👆 Déclaration obligatoire : ce fichier contient du code PHP
...
//                          IMPORTS (USE)
// ============================================================================
// On importe toutes les classes dont on a besoin pour faire fonctionner ce contrôleur
...
// Méthodes disponibles : findAll(), find(1), findBy(), etc.

use Doctrine\ORM\EntityManagerInterface;
// 👆 L'EntityManager = l'outil pour ÉCRIRE dans la base de données
// Méthodes : persist() (préparer) + flush() (sauvegarder vraiment)
...
// - "extends AbstractController" = on hérite des outils pratiques de Symfony
{
    ...
    // C'est ici qu'on reçoit les "outils" dont on a besoin pour travailler
        ...
        // 👆 Outil pour ÉCRIRE en base (ajouter/modifier/supprimer)
    ...
    // - public = accessible depuis l'extérieur (React, curl, Postman...)
    ...
    // 👆 $request permet de lire les paramètres de l'URL (?utilisateur_id=3)
    {
        ...
        // 👆 Exemple : /api/reservation/my?utilisateur_id=3 → $utilisateurId = "3"
...
// ... ensuite, continuer avec la création normale ...
        // ------------------------------------------------------------------------
    ...
    // Exemple : PUT /api/reservation/5/cancel → $id = 5
    ...
    // 👆 $id est extrait automatiquement de l'URL par Symfony
    {
        ...
        if (!$reservation) {
        // 👆 Si aucune réservation trouvée avec cet ID...
            return new JsonResponse([
        ...
        // 👆 Code 200 = "Modification effectuée avec succès"
    }
}
